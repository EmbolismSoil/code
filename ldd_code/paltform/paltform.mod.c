...
__attribute__((section("__versions"))) = {
	...
	{ 0xf3d15944, __VMLINUX_SYMBOL_STR(platform_driver_unregister) },
	{ 0xb1cb3a0d, __VMLINUX_SYMBOL_STR(__platform_driver_register) },
...
MODULE_INFO(srcversion, "F918AF874819FB0B15B51BB");
